...
//  DONE (3) Add a Context field to the constructor and store that context in mContext
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        String highAndLow = highAndLow = SunshineWeatherUtils.formatHighLows(mContext, high, low);

        String weatherSummary = date + " - " + description + " - " + highAndLow;
