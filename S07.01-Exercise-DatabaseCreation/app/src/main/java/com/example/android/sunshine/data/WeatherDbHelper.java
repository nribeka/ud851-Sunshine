...
//  DONE (15) Override onCreate and create the weather table from within it
    ...
    public void onCreate(SQLiteDatabase db) {
        String sqlString = "CREATE TABLE IF NOT EXISTS " + WeatherContract.WeatherEntry.TABLE_NAME
                + "("
                + WeatherContract.WeatherEntry._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                + WeatherContract.WeatherEntry.COLUMN_DATE + " DATE NOT NULL, "
                + WeatherContract.WeatherEntry.COLUMN_DEGREES + " NUMERIC NOT NULL, "
                + WeatherContract.WeatherEntry.COLUMN_HUMIDITY + " NUMERIC NOT NULL, "
                ...
                + WeatherContract.WeatherEntry.COLUMN_PRESSURE + " NUMERIC NOT NULL, "
                + WeatherContract.WeatherEntry.COLUMN_WIND_SPEED + " NUMERIC NOT NULL, "
