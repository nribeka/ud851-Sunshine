...
public class MainActivity extends AppCompatActivity
        implements LoaderManager.LoaderCallbacks<String[]>, ForecastAdapterOnClickHandler {

    private static final String TAG = MainActivity.class.getSimpleName();

    private static int counter = 0;

    private static final int FORECAST_LOADER = 11;
    ...
    public Loader<String[]> onCreateLoader(int id, final Bundle args) {
        Log.i(TAG, "AsyncTaskLoader counter: " + (++ counter));
        return new AsyncTaskLoader<String[]>(this) {

            private String[] forecastCache;

            @Override
            protected void onStartLoading() {
                Log.i(TAG, "onStartLoading ...");
                if(forecastCache != null) {
                    Log.i(TAG, "Returning forecast cache ...");
                    deliverResult(forecastCache);
                } else {
            ...
            public String[] loadInBackground() {
                Log.i(TAG, "Executing loadInBackground ...");
